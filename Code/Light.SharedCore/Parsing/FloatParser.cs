...
namespace Light.SharedCore.Parsing;
...
public static class FloatParser
{
    ...
    /// <param name="value">The parsed float value.</param>
    /// <returns>True if parsing was successful, else false.</returns>
    public static bool TryParse(ReadOnlySpan<char> text, out float value) =>
        TryParse(text, NumberStyles.Number, out value);
    ...
    /// <param name="value">The parsed float value.</param>
    /// <returns>True if parsing was successful, else false.</returns>
    public static bool TryParse(ReadOnlySpan<char> text, NumberStyles style, out float value)
    {
