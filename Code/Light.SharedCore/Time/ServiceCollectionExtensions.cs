...
public static class ServiceCollectionExtensions
{
    ...
    public static IServiceCollection AddUtcClock(this IServiceCollection services) =>
    ...
    /// </summary>
    /// <exception cref="ArgumentNullException">Thrown when <paramref name="services" /> is null.</exception>
    public static IServiceCollection AddLocalClock(this IServiceCollection services) =>
        services.AddSingleton<IClock>(new LocalClock());

    /// <summary>
    /// Adds the <see cref="TestClock" /> as a singleton to the service collection, mapped to <see cref="IClock" />.
    /// </summary>
    /// <exception cref="ArgumentNullException">Thrown when <paramref name="services" /> is null.</exception>
    public static IServiceCollection AddTestClock(this IServiceCollection services) =>
